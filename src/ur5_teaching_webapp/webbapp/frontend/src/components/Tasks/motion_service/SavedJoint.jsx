...
export default function SavedJoint(props) {
  const available_joint = ["home", "sparebay_home"];
  ...
  useEffect(() => {
    console.log(props.selected.data.ros_payload.data);
  }, []);
